...
<div id="container">
	  ...
	  <?php $array9= array(); ?>
        ...
        <?php foreach($results as $res) { ?>
               <?php array_push($array2, $res->answer); 
			         array_push($array3, $res->multiplechoiceid); 
					 ...
					 array_push($array9, $res->description);
			   } ?>
    ...
    <p><?=$array3[$x]?>.<?=$array4[$x]?></p>
      ...
      <?php if ($array2[$x]!=$array1[$x]) { ?>
           ...
           <p><span style="background-color: #ADFFB4"><?=$array2[$x]?> - "<?=$array9[$x]?>"</span></p>
		   
           
      <?php } else { ?>
      
           <p><span style="background-color: #ADFFB4"><?=$array1[$x]?> - "<?=$array9[$x]?>"</span></p>
