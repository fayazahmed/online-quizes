...
<div id="container">
	  ...
	  <?php $array6= array(); ?>
        ...
        <?php foreach($results as $res) { ?>
               <?php array_push($array2, $res->answer); 
			         array_push($array3, $res->blanksid); 
			         array_push($array4, $res->question); 
			         array_push($array5, $res->answer); 
					 array_push($array6, $res->description);
			   } ?>
    ...
    <p><?=$array3[$x]?>.<?=$array4[$x]?></p>
      ...
      <?php if ($array2[$x]!=$array1[$x]) { ?>
           ...
           <p><span style="background-color: #ADFFB4"><?=$array2[$x]?> - "<?=$array6[$x]?>"</span></p>
